...
-- Set the common password as "Clubhouse123"
SET @pwd = '$2b$10$zKGpKcl0uHKA9Tg1GY8Jv.w8T0glQh/v7wFckZTjnyD0hSZJ/gkZu';

-- 1. PLATINUM MEMBER (ID 1: VIP, 4 Guest Passes)
-- Insert the primary Platinum member profile
...
-- Save the generated ID and insert login credentials
SET @plat_id = LAST_INSERT_ID();
INSERT INTO member_auth (membership_id, password_hash) VALUES (@plat_id, @pwd);
-- Insert a default saved payment method for the member
...
-- 2. GOLD MEMBER (ID 2: Standard, 2 Guest Passes)
INSERT INTO membership (public_membership_id, first_name, last_name, email, phone_number, date_of_birth, type_id, start_date, end_date, guest_passes_remaining)
...
-- 3. SILVER MEMBER (ID 3: Restricted, 0 Guest Passes)
INSERT INTO membership (public_membership_id, first_name, last_name, email, phone_number, date_of_birth, type_id, start_date, end_date, guest_passes_remaining)
...
-- 4. FAMILY MEMBER (ID 4: Primary + ID 5: Sub-Member)
INSERT INTO membership (public_membership_id, first_name, last_name, email, phone_number, date_of_birth, type_id, start_date, end_date, guest_passes_remaining)
...
-- Insert the Sub-Member (linked to Primary account, no individual login/email)
...
-- 5. EXPIRED MEMBER (ID 6: Testing Renewal Logic)
INSERT INTO membership (public_membership_id, first_name, last_name, email, phone_number, date_of_birth, type_id, start_date, end_date, guest_passes_remaining)
