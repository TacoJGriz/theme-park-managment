...
INSERT INTO ticket_types (type_name, base_price, description, is_active, is_member_type) VALUES
('Member', 0.00, 'System ticket for active members.', TRUE, TRUE),    
('Adult', 109.00, 'Standard park admission for ages 10-64.', TRUE, FALSE),   
('Child', 99.00, 'Park admission for ages 3-9.', TRUE, FALSE),    
('Senior', 89.00, 'Park admission for ages 65+.', TRUE, FALSE);
