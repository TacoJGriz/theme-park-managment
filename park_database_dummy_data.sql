...
('Daisy', 'Duck', 'Female', '(123) 456-7893', 'daisy@park.com', '126 Main St', 'Orlando', 'FL', '32830', '1940-01-07', '2024-02-15', 'HR', 4, 1, 25.00, TRUE), -- Daisy is now HR
...
('Pluto', 'Dog', 'Male', '(123) 555-1234', 'pluto@park.com', '128 Main St', 'Orlando', 'FL', '32830', '1930-09-05', '2024-04-01', 'Maintenance', 1, 1, 27.50, TRUE); -- Added a second maintenance worker
...
-- 3. EMPLOYEE_AUTH
-- Passwords are all 'Clubhouse123'
...
-- 6. PENDING REQUESTS FOR APPROVAL DEMO
-- Daisy (HR, ID 4) requests a pay raise for Donald (Staff, ID 3) to $19.50
UPDATE employee_demographics 
SET pending_hourly_rate = 19.50, rate_change_requested_by = 4
WHERE employee_id = 3;

-- Goofy (Maintenance, ID 5) requests that the Thunder Mountain job be reassigned to Pluto (Maintenance, ID 6)
UPDATE maintenance
SET pending_employee_id = 6, assignment_requested_by = 5
...
(NULL, '2025-10-20 09:05:12', '17:30:00', 'Adult', 109.00, 0.00), (NULL, '2025-10-20 09:15:00', '16:00:00', 'Child', 99.00, 0.00), (NULL, '2025-10-20 09:30:00', '18:00:00', 'Adult', 109.00, 0.00),
(NULL, '2025-10-20 10:30:00', '18:00:00', 'Child', 99.00, 0.00), (NULL, '2025-10-20 11:30:00', '19:00:00', 'Adult', 109.00, 0.00), (NULL, '2025-10-20 11:35:00', '19:00:00', 'Adult', 109.00, 0.00),
(1, '2025-10-20 12:00:00', '19:30:00', 'Member', 0.00, 0.00), (NULL, '2025-10-20 13:00:00', '20:00:00', 'Senior', 89.00, 0.00), (NULL, '2025-10-20 13:10:00', '20:00:00', 'Adult', 109.00, 0.00);
...
(1, 1, 200), (2, 1, 150), (1, 2, 250), (3, 3, 500), (4, 3, 450);
